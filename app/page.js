...
export default function Home() {
  return (
    <div className="bg-black text-background h-screen flex flex-col justify-center items-center px-6 relative overflow-hidden">
      <div className="flex flex-col justify-center items-center z-10">
        ...
        <p className="mb-6 text-center lg:text-lg mb-2">
          Kısa bir süre içinde yeni web sayfamız yayında olacak
        </p>
      ...
      <div className="color content-none absolute -top-3/4 lg:-top-1/2 h-[500px] w-[500px] lg:h-[1000px] lg:w-[1000px]"></div>
    </div>
  );
}
